...
var emitterHandler : Inference.ParameterType = (cls, property, name) =>
    cls.project === "event-kit" && cls.name === "Emitter" && _.contains(name.toLowerCase(), "handler") && "(...value: any[]) => void";

var emitterEventName : Inference.ParameterName = (cls, property, name) =>
    cls.project === "event-kit" && cls.name === "Emitter" && name === "eventName" && name;

var emitterEmitName : Inference.ParameterName = (cls, property, name) => {
...
var emitterEmitType : Inference.ParameterType = (cls, property, name) =>
    cls.project === "event-kit" && cls.name === "Emitter" && property.name === "emit" && name === "value" && 'any[]';


var disposableEventName : Inference.ParameterName = (cls, property, name) =>
    cls.project === "event-kit" && cls.name === "Disposable" && property.name === "off" && name === "eventName" && name;
